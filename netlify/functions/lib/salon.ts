...
export function buildSystemPrompt(fig: FigureContext, uiLang: Lang, question?: string): string {
  ...
  return [
    ...
    "",
    `LANGUAGE: You would naturally speak ${figureLangName}. Your guest's interface is in ${userLangName}. Speak primarily in ${userLangName} so your guest follows you, but you may flavour your speech with a word or phrase of your own tongue where it's natural. Match the language your guest writes to you in if they switch.`,
    question
